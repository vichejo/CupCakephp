<section id="main" class="column">
    ...
    <article class="module width_3_quarter" style="margin-bottom: 20px">
        <header><h3><?php  __('Detalle de la Consulta');?></h3></header>
		...
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $time->format('d-m-Y H:i',$contacto['Contacto']['created']); ?>
			&nbsp;
		</dd>
    ...
    <article class="module width_quarter">
        ...
        <div class="module_content">
	<ul>
		<li><?php echo $this->Html->link(__('Editar esta Consulta', true), array('action' => 'edit', $contacto['Contacto']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Eliminar esta Consulta', true), array('action' => 'delete', $contacto['Contacto']['id']), null, sprintf(__('¿Está seguro que desea eliminar \'%s\'?', true), $contacto['Contacto']['asunto'])); ?> </li>
