<section id="main" class="column">
    ...
    <article class="module width_3_quarter">
        <header><h3><?php __('Modificar Audio'); ?></h3></header>
        <div class="module_content">
<?php echo $this->Form->create('Audio', array('enctype' => 'multipart/form-data', 'action' => 'edit'));?>
	<?php
		...
		//echo "<fieldset>".$this->Form->input('filename', array('label'=>__('Filename',true)))."</fieldset>";
                echo "<fieldset>";
                $thefilename = $this->data['Audio']['filename'];
		if ($thefilename!=""){ ?>
		...
		//if ($thefilename!=""){
                ...
                //}
                echo "<input type='hidden' name='data[Audio][sinfichero]'value='0'>";
                echo "</fieldset>";
