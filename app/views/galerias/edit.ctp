<section id="main" class="column">
    ...
    <article class="module width_3_quarter">
        <header><h3><?php __('Edit Galeria'); ?></h3></header>
...
<?php echo $this->Form->end(__('Crear/Guardar', true));?>
    ...
    <article class="module width_quarter">
        ...
        <div class="module_content">
            <ul>
		<li><?php echo $this->Html->link(__('Eliminar', true), array('action' => 'delete', $this->Form->value('Galeria.id')), null, sprintf(__('¿Está seguro que desea eliminar \'%s\'?', true), $this->Form->value('Galeria.id'))); ?></li>
