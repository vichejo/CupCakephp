...
<?php echo $this->Form->end(__('Crear/Guardar', true));?>
    ...
    <article class="module width_quarter">
        ...
        <div class="module_content">
            <ul>
		<li><?php echo $this->Html->link(__('Eliminar', true), array('action' => 'delete', $this->Form->value('Submodulo.id')), null, sprintf(__('¿Está seguro que desea eliminar \'%s\'?', true), $this->Form->value('Submodulo.id'))); ?></li>
