...
<?php echo $this->Form->end(__('Guardar', true));?>
    ...
    <article class="module width_quarter">
        ...
        <div class="module_content">
            <ul>
		<li><?php echo $this->Html->link(__('Eliminar este Vídeo', true), array('action' => 'delete', $this->Form->value('Video.id')), null, sprintf(__('¿Está seguro que desea eliminar \'%s\'?', true), $this->Form->value('Video.id'))); ?></li>
