<section id="main" class="column">
    ...
    <article class="module width_3_quarter">
        <header><h3><?php __('Añadir un Vídeo'); ?></h3></header>
        <div class="module_content">
<?php echo $this->Form->create('Video', array('enctype' => 'multipart/form-data', 'action' => 'add'));?>
	<?php
		...
		//echo "<fieldset>".$this->Form->input('url', array('label'=>__('Url del vídeo',true)))."</fieldset>";
