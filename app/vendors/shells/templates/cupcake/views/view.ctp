...
<section id="main" class="column">
    ...
    <article class="module width_3_quarter" style="margin-bottom: 20px">
        <header><h3><?php echo "<?php  __('Detalle de  {$singularHumanName}');?>";?></h3></header>
...
?>
	...
	<ul>
<?php
	echo "\t\t<li><?php echo \$this->Html->link(__('Editar este " . $singularHumanName ."', true), array('action' => 'edit', \${$singularVar}['{$modelClass}']['{$primaryKey}'])); ?> </li>\n";
	echo "\t\t<li><?php echo \$this->Html->link(__('Eliminar este " . $singularHumanName . "', true), array('action' => 'delete', \${$singularVar}['{$modelClass}']['{$primaryKey}']), null, sprintf(__('¿Está seguro que desea eliminar \'%s\'?', true), \${$singularVar}['{$modelClass}']['{$primaryKey}'])); ?> </li>\n";
	echo "\t\t<li><?php echo \$this->Html->link(__('Listado de " . $pluralHumanName . "', true), array('action' => 'index')); ?> </li>\n";
	echo "\t\t<li><?php echo \$this->Html->link(__('Nuevo " . $singularHumanName . "', true), array('action' => 'add')); ?> </li>\n";
...
if (!empty($associations['hasOne'])) :
	...
	<div class="related">
		<h3><?php echo "<?php __('Elemento Relacionado:  " . Inflector::humanize($details['controller']) . "');?>";?></h3>
	...
	<?php echo "<?php endif; ?>\n";?>
		<div class="actions">
			<ul>
				<li><?php echo "<?php echo \$this->Html->link(__('Editar " . Inflector::humanize(Inflector::underscore($alias)) . "', true), array('controller' => '{$details['controller']}', 'action' => 'edit', \${$singularVar}['{$alias}']['{$details['primaryKey']}'])); ?></li>\n";?>
			</ul>
		</div>
	</div>
	<?php
...
foreach ($relations as $alias => $details):
	...
	?>
        ...
        <header><h3><?php echo "<?php __('Elemento Relacionado: " . $otherPluralHumanName . "');?>";?></h3></header>
        <div class="related">
	<?php echo "<?php if (!empty(\${$singularVar}['{$alias}'])):?>\n";?>
...
<?php echo "<?php endif; ?>\n\n";?>
   ...
   <!-- <article class="module width_quarter">
        ...
        <article>
		<ul>
			<li><?php echo "<?php echo \$this->Html->link(__('Nuevo " . Inflector::humanize(Inflector::underscore($alias)) . "', true), array('controller' => '{$details['controller']}', 'action' => 'add'));?>";?> </li>
		</ul>
	</article>
    </article> -->
    </article>
