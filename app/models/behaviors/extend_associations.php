...
/** 
 * 
 * Nota: en pruebas, parece que funciona bien lo de eliminar... pero luego en listados y demas
 * operaciones normales parece que fallan! .... de momento no se está usando
 * 
 * 
 * 
...
Añadir la siguiente línea de código para su modelo. 
...
Desvinculación de todas las asociaciones (con excepciones)
