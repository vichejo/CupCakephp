<?php
// Este componente se ha modificado para que sirva tanto para subir imagenes
// redimensionandolas o para subir ficheros
// Es un componente algo antiguo, aunque funciona.
//
// dispone de 2 metodos: upload_image y upload_file
//
class UploadComponent extends Object {
        ...
        function upload_image ($file, $destination, $name = NULL, $rules = NULL, $allowed = NULL) {
                ...
                if (isset($file) && is_array($file) && !$this->upload_error($file['error'])) {
                        ...
                        if(!in_array($this->ext($fileName),$this->_allowed)){
                                $this->error("Tipo de fichero no permitido.");
                        } else { 
                                ...
                                if (is_uploaded_file($fileTmp)) {
                                        ...
                                        if ($rules == NULL) {
                                                ...
                                                if (move_uploaded_file($fileTmp, $output)) {
                                                        ...
                                                        $this->error("No se puede mover '$fileName' a '$destination'");
                                                }						
                                        } else {
                                                ...
                                                if (function_exists("imagecreatefromjpeg")) {
                                                        ...
                                                        if (isset($rules['type']) && isset($rules['size'])) {
                                                                ...
                                                                $this->error("Parametro \"rules\" invalido");
                                                        }
                                                } else {
                                                        $this->error("Su servidor no tiene instalada la librería GD");
                                                }
                                        }
                                } else {
                                        $this->error("Posible error con el fichero: '$fileName'");
                                }
                        }
                        ...
                        if ($file==""){
                                ...
                                $this->error("Posible error al subir el fichero");
                }
                return $this->result;
        }
        ...
        function upload_file ($file, $destination, $name = NULL, $rules = NULL, $allowed = NULL) {
                ...
                $this->_destination = $destination;	
                if (!is_null($rules)) $this->_rules = $rules;
                if (!is_null($allowed)) { $this->_allowed = $allowed; } else { $this->_allowed = array('pdf','flv','ppt','zip','deb','rar','gz'); }
...
//exit();
         ...
         * @return unknown_type
         */
        function upload_video ($file, $destination, $name = NULL, $rules = NULL, $allowed = NULL) {
                ...
                $this->_destination = $destination;	
                if (!is_null($rules)) $this->_rules = $rules;
                if (!is_null($allowed)) { $this->_allowed = $allowed; } else { $this->_allowed = array('m4v','ogv','ogg','webm'); }
...
/**
         ...
         * @return unknown_type
         */
        function upload_audio ($file, $destination, $name = NULL, $rules = NULL, $allowed = NULL) {
                ...
                $this->_destination = $destination;	
                if (!is_null($rules)) $this->_rules = $rules;
                if (!is_null($allowed)) { $this->_allowed = $allowed; } else { $this->_allowed = array('mp3','m4a','webm','oga','wav','ogg'); }
